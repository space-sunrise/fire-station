...
### 🚫 Анти-паттерн: НЕ английский языке в YAML прототипе
...
Поля в прототипе обязаны соответствовать английской локализаци в FTL. Изменение одного требует измененеи другого.
