...
public sealed partial class ScpTab : Control
{
    ...
    public ScpTab()
    {
        ...
        Control.AddOptionSlider(ScpCCVars.SinCityStrength, SinCityStrengthSlider,
            SinCityOverlayComponent.BaseStrengthLimit.Min, SinCityOverlayComponent.BaseStrengthLimit.Max);
