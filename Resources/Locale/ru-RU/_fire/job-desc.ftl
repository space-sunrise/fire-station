job-name-containment-specialist = Специалист по Сдерживанию
job-description-containment-specialist = Работает непосредственно с аномальными объектами фонда.
job-name-biological-defense-specialist = Специалист биологической защиты
...
job-name-senior-containment-guard = Старший Охранник Зоны Содержания
job-description-senior-containment-guard = Распоряжается персоналом класса D и следит за охраной.
job-name-containment-guard = Охранник Зоны Содержания
