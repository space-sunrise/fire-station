id-card-access-level-command = Руководство
id-card-access-level-captain = Директор Комплекса
id-card-access-level-head-of-personnel = Кадровый Офицер
id-card-access-level-cryogenics = Криогеника
id-card-access-level-head-of-security = Начальник Охраны
...
id-card-access-level-chief-engineer = Главный техник
id-card-access-level-engineering = Инженерный
id-card-access-level-atmospherics = Атмосферный
id-card-access-level-research-director = Глава Научной Службы
...
id-card-access-level-quartermaster = Глава Службы Логистики
