scp-radio-cycle-channel = Переключить канал связи
scp-radio-toggle-radio = Вкл/выкл
scp-radio-current-channel = Текущий канал связи теперь: {$name}
scp-radio-microphone = Микрофон {$value ->
    [true] включен
    *[false] выключен
}
