...
ui-options-Compatibility-mode-show-warning-tooltip =
    Определяет, будете ли вы получать предупреждение о включенном режим совместимы при каждом заходе в игре.
    Внимание: Для 99.999% игроков рекомендуется проследовать инструкции из предупреждения и выключить режим совместимости.
...
ui-options-Compatibility-mode-use-shaders-tooltip =
    Позволяет шейдерам работать в режиме совместимости, не смотря на графические артефакты.
    Включите, если хотите попробовать поиграть так.
