...
ui-options-light-bloom-optimizations-tooltip =
    При включении источники света, которые не видны персонажу не будут создавать эффекта.
...
ui-options-light-bloom-strength-tooltip =
    Регулирует яркость эффекта свечения. Чем выше значение, тем выше яркость.
    Позволяет настроить все по своему предпочтению.
