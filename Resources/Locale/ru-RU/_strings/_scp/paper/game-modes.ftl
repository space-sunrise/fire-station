...
paper-keter-mode-info =
    ...
    Участок перешлёл в режим расширенного содержания. Один или несколько аномальных субъектов представляют серьёзную и непосредственную угрозу существующим протоколам безопасности.
