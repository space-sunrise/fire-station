...
bounty-item-dclass-uniform = Униформа класса D
...
bounty-item-bandana = Бандана ### Надо добавить в принтер униформ
...
bounty-description-dclass-uniform = В соседнем учреждении закончилась форма для персонала класса D, так что если у вас есть запасная одежда, мы заберём её у вас.
