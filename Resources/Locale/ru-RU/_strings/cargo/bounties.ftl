...
bounty-item-ore-bananium = Бананиевая руда
...
bounty-item-plates = Пластинки шкуры голиафа
...
bounty-description-flashes = ПРИВЕТСТВУЮ \[Станция] НАМ ТРЕБУЮТСЯ 6 ВСПЫШЕК ДЛЯ ОБЫЧНОГО \[УчебногоУпражнения] СО СЛУЖБОЙ БЕЗОПАСНОСТИ. ВСЁ \[Нормально].
bounty-description-ring = В этот ОСОБЕННЫЙ день у семьи Гельт состоится свадьба, но мистер Гельт потерял кольца. Нужна новая пара.
