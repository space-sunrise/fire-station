...
bounty-description-warm-cloth = Строительная бригада мигрантов не может восстановить электропитание на в своем комплексе и замерзает. Нужно прислать им хоть какую-нибудь тёплую одежду.
