...
job-name-station-ai = Рекрут c искусственным интеллектом
...
JobStationAi = Рекрут c искусственным интеллектом
