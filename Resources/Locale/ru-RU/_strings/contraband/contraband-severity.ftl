...
contraband-examine-text-GrandTheft = [color=red]Этот предмет является ценным объектом для [color=green]Повстанцев Хаоса[/color]![/color]
contraband-examine-text-Syndicate = [color=crimson]Этот предмет является высоко нелегальной контрабандой [color=green]Повстанцев Хаоса[/color]![/color]
