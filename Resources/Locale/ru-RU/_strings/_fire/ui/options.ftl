...
ui-options-field-of-view-use-alt-method = Использовать альльтернативный метод просчета поля зрения
...
ui-options-field-of-view-blur-scale-tooltip = Определяет качество текстуры размытия. Чем больше, тем ресурсозатратная текстура
