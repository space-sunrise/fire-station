...
paper-euclid-mode-info =
    ...
    ​[bullet] Службе безопасности рекомендуется усиленно контроллировать любые взаимодействия с аномальными объектами.
...
paper-thaumiel-mode-info =
    ...
    ​[bullet] Служба безопасности обязана установить полный контроль над взаимодействием с SCP объектами. Количество одновременных взаимодействий не должно превышать более 1 раза раз в 20 минут
