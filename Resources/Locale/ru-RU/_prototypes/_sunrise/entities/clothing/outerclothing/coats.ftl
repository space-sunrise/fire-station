...
ent-ClothingOuterCoatNtrep = пиджак представителя NT
    .desc = Элегантная черная куртка, стандартный атрибут представителей Фонда.
...
ent-ClothingOuterCoatCaptainOvercoat = капитанская шинель
    .desc = Селанная специально под замеры действующего капитана и сделанный лучшими швеями.
