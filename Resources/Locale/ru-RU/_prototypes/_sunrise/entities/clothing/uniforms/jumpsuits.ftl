...
ent-ClothingUniformJumpsuitSalvageMercWhite = белый комбинезон мусорщика
    .desc = Практичная форма для утилизаторов.
ent-ClothingUniformJumpsuitSalvageMercGreen = зелёный комбинезон мусорщика
    .desc = Практичная форма для утилизаторов.
ent-ClothingUniformJumpsuitSalvageMercBrown = коричневый комбинезон мусорщика
    .desc = Практичная форма для утилизаторов.
