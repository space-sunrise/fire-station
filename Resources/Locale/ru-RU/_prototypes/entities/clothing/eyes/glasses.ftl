...
ent-ClothingEyesGlassesSecurity = баллистические очки
    .desc = Баллистические очки, используемые военными и бойцами спецподразделений. Имеют встроенный визор охраны.
