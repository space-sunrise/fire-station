ent-CrateAdministrationRecontainmentCircuitsBoards = набор плат законов фонда SCP
    .desc = Содержит набор из 2 плат законов для Системы Безопасности Комплекса - "{ ent-ScpMtfCircuitBoard }" и "{ ent-ScpDefaultCircuitBoard}", а также "{ ent-Intellicard }".
    .suffix = Заполненный
...
ent-CrateAdministrationRecontainment096 = набор Восстановления Условий Содержания SCP 096
    .desc = Содержит набор для Восстановления Условий Содержания SCP 096. Шлем, который находится в наборе, имеет встроенный Искусственный Интеллект, что позволит смотреть на лицо объекта без опасений (9 из 10 сотрудников рекомендуют, 10-й умер и не дал оценку)
    .suffix = Заполненный
