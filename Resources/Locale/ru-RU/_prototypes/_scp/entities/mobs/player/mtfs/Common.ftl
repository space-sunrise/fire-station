...
ent-DeathRattleImplantMTF = имплант Предсмертный хрип МОГ
...
ent-BoxMTFImplants = коробка имплантеров "Предсмертный трекер"
    .desc = Шесть "{ ent-DeathRattleImplantMTF }" для всего отряда. Такие импланты по стандарту стоят в оперативниках Мобильных Оперативных Групп.
...
ent-CrateAdministrationCrateScpCageScp066 = ящик с ангаром «Диатоника»
    .desc = Содержит ангар «Диатоника». Идеальный ангар, чтобы вернуть SCP-066 в его камеру!
    .suffix = Заполненный
