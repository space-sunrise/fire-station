...
ent-ClothingHeadHatCapDirector = фуражка директора комплекса
    .desc = Большая, стильная фуражка директора
ent-ClothingUniformJumpsuitDirector = костюм директора
    .desc = Костюм для особых случаев
ent-ClothingUniformJumpsuitBlueDirectorFormal = торжественный синий костюм директора
    .desc = Костюм для исключительных сценариев
...
ent-ClothingHandsGlovesDirector = перчатки директора комплекса
    .desc = Отличают вас от них
