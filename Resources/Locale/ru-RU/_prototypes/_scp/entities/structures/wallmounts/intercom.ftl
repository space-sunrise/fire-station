ent-IntercomHeavyContainmentSecurityService = { ent-Intercom }
    .desc = Интерком. Он был укреплён металлом из шлемов охраны тяжелой зоны содержания, поэтому открыть его не так-то просто.
...
ent-IntercomExternalAdministrativeZoneSecurityService = { ent-IntercomHeavyContainmentSecurityService }
    .desc = Интерком. Он был укреплён металлом из шлемов охраны внешней-административной зоны, поэтому открыть его не так-то просто.
