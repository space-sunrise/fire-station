...
ent-Scp106Cloth = rotten cloth
    .desc = Black and sticky piece of fabric that burns to the touch.
ent-Scp2295Fiber1 = colorful fiber
    .desc = Colorful soft fibers with the smell of medicine and bleach, just like in hospitals.
ent-ScpUniversalCloth = beige cloth
    .desc = A strange-feeling beige piece of cloth.
