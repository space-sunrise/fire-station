...
alert-level-scpLime-instruction = Act in accordance with Lime Code unless otherwise instructed by the Complex Administration or Security Service. Immediately report any electronic malfunctions to the engineering department.
