...
alert-level-scpNone-instructions = Do your job.
...
alert-level-scpLime = Lime
alert-level-scpLime-announcement = According to some reports, the complex has sustained irreparable structural damage, a failure of the life-support system, or extensive destruction. Personnel should evacuate the damaged area and notify the engineering department.
alert-level-scpLime-instructions = Act in accordance with Lime Code unless otherwise instructed by the Complex Administration or Security Service. Immediately report any electronic malfunctions to the engineering department.
