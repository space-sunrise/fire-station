...
chat-emote-name-growls = Growl
chat-emote-msg-growls = growls
chat-emote-name-mews = Mew
chat-emote-name-oink = Oink
chat-emote-msg-oink = oinks
chat-emote-name-meows = Meow
chat-emote-name-vomit = Nausea
chat-emote-name-headache = Headache
chat-emote-name-insult = Stroke
chat-emote-name-severe-cough = Severe Cough
chat-emote-msg-severe-cough = coughs heavily
chat-emote-msg-call = calls out
chat-emote-msg-squawk = squawks
chat-emote-msg-scree = screeches
chat-emote-name-call = Call Out
chat-emote-name-squawk = Squawk
chat-emote-name-scree = Screech
