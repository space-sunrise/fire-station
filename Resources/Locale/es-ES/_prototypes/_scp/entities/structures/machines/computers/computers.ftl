...
ent-ScpComputerShuttleChaosInsurgency = consola de control del transbordador insurgente del caos
...
ent-ScpComputerFacilityRecords = consola de registro de personal
...
ent-ScpComputerCommunicationChaosInsurgency = consola de comunicaciones insurgente del caos
    .desc = { ent-SyndicateComputerComms.desc }

ent-ScpComputerCommunicationRegionalAdministration = consola de comunicaciones de gestión regional
    .desc = consola, que se utiliza para transmitir alertas importantes.
ent-ScpComputerCommunicationO4Headquarters = Consola de comunicaciones sede O4
    .desc = consola, que se utiliza para transmitir alertas importantes.
...
ent-ScpComputerLogisticsFinanceConsole = consola financiera del departamento de logística
...
ent-ScpComputerCallMtfConsole = Consola de llamadas MTF
    .desc = { ent-ComputerCallErtConsole.desc }
    .suffix = LLAMAR PODRÍA
